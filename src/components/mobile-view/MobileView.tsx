...
const MobileView = () => {
  ...
  console.log("template-mapper", template);
  ...
  return (
    <div className="relative mt-16 mx-auto border-gray-800 bg-gray-800 border-[14px] max-2xl:border-[8px] max-xl:border-[6px] rounded-[2.5rem] h-[669px] w-[328px] shadow-xl max-2xl:h-[560px] max-2xl:w-[270px] max-xl:h-[475px] max-xl:w-[230px] max-lg:h-[405px] max-lg:w-[197px]">
      ...
      <div className={`rounded-[2rem] ${templatePersonalized.templateColor} scrollbar-hidden overflow-y-auto w-[300px] h-[641px] max-2xl:w-[255px] max-2xl:h-[544px] max-xl:w-[217px] max-xl:h-[462px] max-lg:w-[185px] max-lg:h-[392px]`}>
