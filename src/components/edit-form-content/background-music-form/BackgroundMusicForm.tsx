  ...
  return (
    <div className="border-b-2 border-custom-pink">
      <div className="flex items-center justify-center w-full p-5 gap-5">
        <p
          className={`${
            isPlayed ? "text-custom-pink" : "text-custom-gray"
          } w-[50%] font-semibold`}
        >
          {name}
        </p>
        <div className="w-[50%] flex items-center justify-center gap-5 lg:w-[75%]">
          <Button
            ...
            className="w-full min-w-28 text-custom-white gap-2"
          >
            <img
              src={
                isPlayed ? "assets/images/stop.png" : "assets/images/play.png"
              }
              alt="button"
              className="w-5"
            />
  ...
  return (
    <div className="flex flex-col gap-7 overflow-y-auto scrollbar-hidden">
      <div className="flex flex-col gap-2">
        <h1 className="font-semibold text-lg text-custom-gray">
          The song chosen for the invitation:
        </h1>
        <MusicDisplay
          active={backgroundMusic === "" ? false : true}
      ...
      <div className="flex flex-col gap-3">
        <div>
          ...
          <p className="font-semibold text-sm text-[#a8a8a8]">
            This feature is only accessible to subscribers
            <span className="text-custom-pink">*</span>
          </p>
        </div>
        <input
          className="block w-full border border-custom-pink rounded-lg cursor-pointer focus:outline-none p-3 gap-3"
          type="file"
