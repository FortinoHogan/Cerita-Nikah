...
const SubDomainForm = () => {
  ...
  const [subDomain, setSubDomain] = useState(domain);
    ...
    <div className="flex flex-col gap-3">
      <div>
        <h1 className="font-semibold text-lg text-custom-gray">
          Custom your sub domain according to your wishes
        </h1>
        <p className="font-semibold text-sm text-[#a8a8a8]">
          Only Subscribers can custom their sub domain
      ...
      <div className="flex items-center gap-2">
        <div className="relative flex flex-col gap-1 w-full">
          ...
          />
          <p className="absolute top-3 right-3 text-custom-gray font-semibold">
            .ceritanikah.online
          </p>
        </div>
        {isAlreadyTaken ? (
          <img
            src="assets/images/sub-domain-unavailable.png"
            alt=""
            className="w-5"
          />
        ) : (
          <img
            src="assets/images/sub-domain-available.png"
            alt=""
            className="w-5"
          />
        )}
