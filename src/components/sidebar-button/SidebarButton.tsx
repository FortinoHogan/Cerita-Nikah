...
const SidebarButton = (props: ISidebarButton) => {
    ...
    return (
        <div className={`flex items-center gap-5 cursor-pointer p-5 mx-5 rounded-xl transition ease-in-out duration-75 ${isActive === text ? 'bg-custom-pink' : 'hover:bg-custom-pink hover:bg-opacity-40'}`} onClick={onClick}>
