    ...
    return (
        <div className='pt-4 pb-6 px-6 rounded-3xl border-custom-pink border-2 absolute top-0 right-0 flex flex-col gap-6 '>
            ...
            <div className='flex items-center justify-center gap-14'>
                <FloatingDeviceButton image="assets/images/phone-view.png" imageActive='assets/images/phone-view-active.png' onClick={() => { setIsActive('phone'); setDeviceState('phone') }} isActive={isActive} type='phone' />
