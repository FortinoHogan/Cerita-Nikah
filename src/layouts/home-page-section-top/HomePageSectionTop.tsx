        ...
        <div className='relative min-h-screen flex items-center justify-center'>
            <div className='flex items-center justify-center w-full'>
                <div className='w-[50%] max-sm:w-[100%] z-40 flex flex-col gap-10 px-56 max-2xl:px-12 max-xl:px-8 '>
                    ...
                    <Button onClick={() => { }} text="Create Now!" className="text-custom-white w-[165px] max-sm:w-[150px]" />
                </div>
                <div className='w-[50%] z-40 flex items-center justify-center my-20 max-sm:hidden'>
                    <img src="assets/images/homepage-right-image.png" alt="homepage" className='w-[50rem] max-2xl:w-[30rem] max-xl:w-[20rem]' />
                </div>
            </div>
        </div>
    )
